...
public class InitializeServiceImpl implements InitializeService {
    ...
    public void initializeSubcategoryTable() {
        ...
        Subcategory subcategory1 = new Subcategory( "Bags", new Category( "Woman"));
        Subcategory subcategory2 = new Subcategory("Accessories", new Category( "Woman"));
        Subcategory subcategory3 = new Subcategory( "Jewlery", new Category( "Woman"));
        Subcategory subcategory4 = new Subcategory( "Shoes", new Category( "Woman"));
        Subcategory subcategory5 = new Subcategory( "Sportwear", new Category( "Men"));
        Subcategory subcategory6 = new Subcategory( "Chairs", new Category( "Home"));
        Subcategory subcategory7 = new Subcategory( "Tables", new Category( "Home"));
        Subcategory subcategory8 = new Subcategory( "Toys", new Category( "Kids"));
        Subcategory subcategory9 = new Subcategory( "Books", new Category("Kids"));
